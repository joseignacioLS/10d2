                ...
                sessions: [
                    {
                        id: "0-0-0",
                        number: 0,
                        title: "Los calabozos de Tantir",
                        author: "1-0",
                        summary: {
                            text: `<h3>El Crisol del Grupo</h3>
<p>Para aquellos que no hayan estado en Tantir, es un lugar tranquilo en los lindes del bosque al norte de Merth. El aire allí huele a resina fresca y, al entrar en contacto con la piel, te hace sentir ese frío de motnaña que a los amantes de la naturaleza nos reconforta tanto. Sus gentes viven de la caza y el forrajeo, pero sobre todo del comercio. No dudéis en visitar sus tiendas y su taberna, Tantir está lleno de lugares encantadores y gentes amables.</p>
